  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Gestion des candidatures et shortlists</p>
      </div>
      ...
      <div className="mb-8">
        <Link
          href="/dashboard/client/shortlist"
          className="bg-blue-600 text-white rounded-lg p-6 hover:bg-blue-700 transition-colors inline-flex items-center"
        >
          <Users className="w-6 h-6 mr-3" />
          <div>
            <h3 className="font-semibold">Voir les shortlists</h3>
            <p className="text-sm text-blue-100 mt-1">{shortlists.length} candidat(s) en shortlist</p>
          </div>
        </Link>
      </div>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Candidats récents</h2>
        </div>
        <div className="p-6">
          {shortlists.length > 0 ? (
            <div className="space-y-4">
              {shortlists.slice(0, 5).map((item) => (
                <Link
            ...
            <p className="text-gray-500">Aucun candidat en shortlist</p>
          )}
        </div>
      </div>
    </div>
