      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex items-start gap-3 flex-1 min-w-0">
          ...
          {candidate.profile_picture_url || candidate.photo_url ? (
            ...
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-400 to-indigo-600 flex items-center justify-center flex-shrink-0 border-2 border-gray-200">
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      >
          ...
          <div className="flex gap-4 min-w-max lg:min-w-0">
            {DISPLAYED_STATUSES.map((status) => {
              ...
              const statusColors: Record<string, { bg: string; text: string; border: string }> = {
                ...
                'qualifié': { bg: 'bg-indigo-50', text: 'text-indigo-700', border: 'border-indigo-300' },
        ...
        <DragOverlay>
          {activeCandidate ? (
            <div className="bg-white p-4 rounded-lg shadow-xl border-2 border-indigo-300 w-64">
              <div className="flex items-start gap-3">
                {activeCandidate.profile_picture_url || activeCandidate.photo_url ? (
                  <img
                    ...
                    className="w-10 h-10 rounded-full object-cover flex-shrink-0 border-2 border-indigo-300"
                  />
                ) : (
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-400 to-indigo-600 flex items-center justify-center flex-shrink-0 border-2 border-indigo-300">
                    <span className="text-white font-semibold text-xs">
