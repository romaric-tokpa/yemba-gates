...
import { Users, Shield, Settings, Activity, TrendingUp } from 'lucide-react'
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        >
          ...
          <p className="text-sm text-gray-300 mt-1">{users.length} utilisateur(s)</p>
        </Link>
        <Link
          href="/admin/logs"
          className="bg-gray-800 text-white rounded-lg p-6 hover:bg-gray-900 transition-colors"
        >
          ...
          <p className="text-sm text-gray-300 mt-1">Historique des connexions</p>
        </Link>
        <Link
          href="/admin/settings"
          className="bg-gray-800 text-white rounded-lg p-6 hover:bg-gray-900 transition-colors"
        >
          ...
          <p className="text-sm text-gray-300 mt-1">Configuration système</p>
        </Link>
      </div>
