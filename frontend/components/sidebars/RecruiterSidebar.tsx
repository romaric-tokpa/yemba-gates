  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-blue-600 rounded-lg shadow-lg border border-blue-700"
      ...
      <aside className={`
        ...
        w-64 bg-blue-600 border-r border-blue-700 flex flex-col
        ...
        <div className="p-6 border-b border-blue-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-200">Espace Recruteur</p>
            </div>
          </div>
        </div>
            ...
            <>
              <div className="flex items-center space-x-3 px-4 py-3 mb-2">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-blue-200 capitalize">{userInfo.user_role}</p>
                </div>
              </div>
              <button
