  ...
  return (
    <>
      ...
      `}>
        <div className="p-6 border-b border-emerald-800/30">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-emerald-100/80">Espace Manager</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-emerald-800/30 bg-emerald-800/10">
          {userInfo && (
            <div className="p-2">
              <button
              ...
              >
                ...
                <div className="flex-1 min-w-0 text-left">
                  ...
                  <p className="text-[10px] text-emerald-100/80 capitalize truncate">{userInfo.user_role}</p>
                </div>
                <ChevronDown className={`w-3.5 h-3.5 text-emerald-100/70 transition-transform flex-shrink-0 ${isUserMenuOpen ? 'rotate-180' : ''}`} />
              </button>
              {isUserMenuOpen && (
                <div className="mt-1 px-2 pb-2 space-y-0.5">
                  <Link
                    href="/profile/change-password"
                    className="flex items-center gap-2 px-2 py-1.5 rounded-md text-xs text-emerald-100 bg-white/5 hover:bg-white/15 transition-colors"
                    onClick={() => {
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-2 py-1.5 rounded-md text-xs text-emerald-100 bg-white/5 hover:bg-white/15 transition-colors"
                  >
